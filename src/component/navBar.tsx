    ...
    return (
        <header className="mx-16 px-1 py-4 flex justify-between items-center">
            ...
            <div className="flex items-center gap-4">
                <button className="w-10 h-10 bg-white text-green-900 rounded-full flex items-center justify-center">
                <FaUser className="w-6 h-6 text-black" />
                </button>
                <button className="w-10 h-10 bg-[#007545] rounded-full flex items-center justify-center">
